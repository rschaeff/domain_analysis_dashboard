...
import MinimalMolstarViewer, { Domain } from '@/components/visualization/MinimalMolstarViewer';
...
export default function MinimalTestPage() {
  ...
  const handleError = (error: string) => {
    // This won't trigger console.error directly
    setErrorMessage(error);
    // Using plain DOM methods to display error info
